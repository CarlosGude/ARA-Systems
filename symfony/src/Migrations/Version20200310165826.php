 ...
 */
final class Version20200310165826 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add user to category';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD user_id VARCHAR(255) DEFAULT NULL');
