 ...
 */
final class Version20200315210629 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create media object table';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company ADD image_id VARCHAR(255) DEFAULT NULL');
